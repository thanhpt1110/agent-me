...
- 2026-05-10 — Add a chat tab to the dashboard later (separate `chat_sessions` table, never touch bridge's `claude_sessions`). Out of Phase 4 draft scope; come back when Slack chat UX limitations bite. _(context: user mentioned occasional chat while picking the tunnel)_
